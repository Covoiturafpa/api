 ...
 */
@Configuration
// @EnableWebSecurity(debug = true) ça c'est pour le mode debug, si on veut débugger, quoi. Parfois ça aide.
@EnableWebSecurity // ça c'est sans le mode debug, si on veut pas débugger, quoi.
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.cors(cors -> cors.configurationSource(corsConfigurationSource()))
                ...
                .authorizeHttpRequests((authz) -> authz
                        ...
                        // .requestMatchers(HttpMethod.GET, "/api/centre/**").hasAuthority("ROLE_TEACHER")
                        .requestMatchers(HttpMethod.GET, "/api/centre/**").permitAll()
